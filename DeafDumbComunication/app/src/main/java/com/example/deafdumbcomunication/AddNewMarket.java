...
public class AddNewMarket extends AppCompatActivity {
    ...
    String Storage_Path = "MarketImages/";
    Items items;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        uploadImage.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                {
                    Toast.makeText(AddNewMarket.this , "Upload in progress please wait" , Toast.LENGTH_SHORT).show();
                }
                    ...
                    .addOnCompleteListener(new OnCompleteListener<Uri>() {
                        ...
                        public void onComplete(@NonNull Task<Uri> task) {
                            ...
                            if (task.isSuccessful()) {
                                ...
                                Toast.makeText(AddNewMarket.this , "Data Successfully Uploaded" , Toast.LENGTH_SHORT).show();

                            } else {
                                // Handle failures
                                // ...
                                Toast.makeText(AddNewMarket.this , "Error While Uploaded" , Toast.LENGTH_SHORT).show();
                            }
