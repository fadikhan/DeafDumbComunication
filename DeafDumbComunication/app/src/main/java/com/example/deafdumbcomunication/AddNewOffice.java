...
public class AddNewOffice extends AppCompatActivity {
    ...
    String Storage_Path = "OfficeImages/";
    Items items;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        databaseReference = FirebaseDatabase.getInstance().getReference("Office");
        ...
        uploadImage.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                {
                    Toast.makeText(AddNewOffice.this , "Upload in progress please wait" , Toast.LENGTH_SHORT).show();
                }
                    ...
                    .addOnCompleteListener(new OnCompleteListener<Uri>() {
                        ...
                        public void onComplete(@NonNull Task<Uri> task) {
                            ...
                            if (task.isSuccessful()) {
                                ...
                                Toast.makeText(AddNewOffice.this , "Data Successfully Uploaded" , Toast.LENGTH_SHORT).show();

                            } else {
                                // Handle failures
                                // ...
                                Toast.makeText(AddNewOffice.this , "Error While Uploaded" , Toast.LENGTH_SHORT).show();
                            }
