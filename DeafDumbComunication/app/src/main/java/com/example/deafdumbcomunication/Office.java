...
public class Office extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerView.setLayoutManager(new LinearLayoutManager(Office.this));
        ...
        bottomNavigationView.setOnNavigationItemReselectedListener(new BottomNavigationView.OnNavigationItemReselectedListener() {
            ...
            public void onNavigationItemReselected(@NonNull MenuItem menuItem) {
                switch (menuItem.getItemId()) {
                    case R.id.nav_home:
                        Intent i = new Intent(Office.this, MainActivity.class);
                        startActivity(i);
                        break;
                    case R.id.nav_add:
                        Intent ii = new Intent(Office.this, Add_New.class);
                        startActivity(ii);
                        break;
                    case R.id.nav_fav:
                        Intent iii = new Intent(Office.this, Favorite.class);
                        startActivity(iii);
                        break;
    ...
    protected void onStart() {
        ...
        FirebaseRecyclerOptions<Items> options = new FirebaseRecyclerOptions.Builder<Items>()
                ...
                .build();
        FirebaseRecyclerAdapter<Items, Office.ItemViewHolder> adapter =
                new FirebaseRecyclerAdapter<Items, Office.ItemViewHolder>(options) {
                    @Override
                    protected void onBindViewHolder(@NonNull final Office.ItemViewHolder itemViewHolder, final int position, @NonNull final Items items) {


                        itemViewHolder.imageName.setText(items.getItem_Name());
                        Glide.with(Office.this)
                        ...
                        itemViewHolder.imageView.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                    ...
                                    Toast.makeText(Office.this, items.getItem_Desc() + itemViewHolder.quantity.getText() + "عدد  ", Toast.LENGTH_SHORT).show();
                        ...
                        itemViewHolder.fvtBtn.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                ...
                                Toast.makeText(Office.this , "Added To Fovorite",Toast.LENGTH_SHORT).show();
                    ...
                    @NonNull
                    @Override
                    public Office.ItemViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
                        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.items, parent, false);
                        return new Office.ItemViewHolder(view);
                    }
                };
